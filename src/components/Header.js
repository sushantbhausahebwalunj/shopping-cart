...
const Header = () => {
  ...
  return (
    ...
    <Container>
      ...
      <Nav>
        <Dropdown alignRight style={{marginRight:"90px"}}>
            ...
            <>
              {
                cart.map((prod) =>(
                  <span className='cartitem' key={prod.id}>
                    ...
                    <div className='cartItemDetail'><span>{prod.name}</span>
                    <span>&#8377; {prod.price.split(".")[0]}</span></div>
              ...
              <Link to="/cart">
                <Button className='cart' style={{width:"95%",margin:"0 10px"}}>Go To Cart</Button>
              </Link>
            </>
